...
namespace SpectrumAnalyzer.Controls
{
    ...
    public partial class AudioLine
    {
        ...
        {
            get => (double) GetValue(SpeedDroppingProperty) * MiniCast.Client.Properties.Settings.Default.Rate;
        ...
        {
            get => (double) GetValue(SpeedRaisingProperty) * MiniCast.Client.Properties.Settings.Default.Rate;
